...
from evoalgo.utils.utils import plot_fit_history_comparison
...
def run_evolution_strategy_algorithms(max_gen_num, pop_size, params_num, task_name,
    ...
    plot_fit_history_comparison(max_fit_history_dict, 'Max', max_gen_num, task_name, pop_size, optimal_fit)
    plot_fit_history_comparison(avg_fit_history_dict, 'Avg', max_gen_num, task_name, pop_size, optimal_fit)


def test_optimization_problems():
    """
    Runs the algorithms with a population of 10, for 10 generation.
    """
    run_evolution_strategy_algorithms(10, 10, params_num_rst, task_name_rst, fitness_function_rst, optimal_fit_rst)
    run_evolution_strategy_algorithms(10, 10, params_num_nn, task_name_nn, fitness_function_nn, optimal_fit_nn)
